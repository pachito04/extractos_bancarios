import type {
  ValidatedMovement, ClassifiedMovement,
  AccountingCategory,
} from '../types';
...
interface ClassificationRule {
  ...
  subcategoria?: string;
  /** Keywords that EXACTLY identify this category (high confidence) */
  exact: RegExp[];
  /** Contextual / partial patterns (medium confidence, review required) */
  contextual?: RegExp[];
}
...
function classifyMovement(mov: ValidatedMovement): ClassifiedMovement {
 ...
 */
export function classifyMovements(movements: ValidatedMovement[]): ClassifiedMovement[] {
