...
exports.DEFAULT_ACCOUNT_PLAN = void 0;
exports.generateLibroDiario = generateLibroDiario;
// ---------------------------------------------------------------------------
// Default Argentine account plan (configurable)
// ---------------------------------------------------------------------------
exports.DEFAULT_ACCOUNT_PLAN = {
    rules: [
...
function getMapping(categoria, plan) {
 ...
 */
function generateLibroDiario(movements, accountPlan = exports.DEFAULT_ACCOUNT_PLAN) {
    const entries = [];
    let numero = 1;
...
//# sourceMappingURL=libro-diario.js.map