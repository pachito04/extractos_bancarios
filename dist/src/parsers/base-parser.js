...
exports.formatArgentino = formatArgentino;
exports.round2 = round2;
exports.normalizeDate = normalizeDate;
exports.cleanDesc = cleanDesc;
exports.isAmount = isAmount;
exports.deltaDC = deltaDC;
// ---------------------------------------------------------------------------
// Amount helpers
// ---------------------------------------------------------------------------
/**
...
function normalizeDate(raw) {
    ...
    if (dashShort)
        return `${dashShort[1]}/${dashShort[2]}/20${dashShort[3]}`;
 ...
 */
function deltaDC(saldoActual, saldoAnterior) {
    const diff = round2(saldoActual - saldoAnterior);
    if (diff > 0.01)
        return { debito: 0, credito: round2(diff) };
    if (diff < -0.01)
        return { debito: round2(-diff), credito: 0 };
